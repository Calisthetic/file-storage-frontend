...
type IconStarProps = ColorProps & SizeProps & IsActiveProps
const IconStar: FunctionComponent<IconStarProps> = ({firstColor, secondColor, width, height, isActive}:IconStarProps) => {
  return isActive ? ( 
