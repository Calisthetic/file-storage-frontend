  ...
  return (
    <div className="h-full px-3 pb-4 overflow-y-auto bg-backgroundLight dark:bg-backgroundDark">
          <ul className="space-y-1 font-medium">
            <motion.li initial={{y: 20, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{delay: 0, stiffness: 300, damping: 24}}>
            ...
            <motion.li initial={{y: 20, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{delay: 0.02, stiffness: 300, damping: 24}}>
            ...
            <motion.li initial={{y: 20, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{delay: 0.04, stiffness: 300, damping: 24}}>
            ...
            <motion.li initial={{y: 20, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{delay: 0.06, stiffness: 300, damping: 24}}>
            ...
            <motion.li initial={{y: 20, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{delay: 0.08, stiffness: 300, damping: 24}}>
            ...
            <motion.li initial={{y: 20, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{delay: 0.1, stiffness: 300, damping: 24}}>
