  ...
  return (
    <div>
      ...
      <aside id="logo-sidebar" className="fixed top-0 left-0 z-30 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li>
                <Link to="upgrade" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
          ...
          {/* Dropdown banner */}
          <div ref={adRef} id="dropdown-cta" className="p-4 mt-6 transition rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
      ...
      <div className="p-4 mt-14 sm:ml-64">
        <Routes>
          <Route path='/' element={<div>usual disk</div>}>
          </Route>
