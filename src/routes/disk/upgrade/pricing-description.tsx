  ...
  return ( 
    props.active === true ? (
      <li className="flex space-x-3 items-center">
        ...
        <span className="text-base text-textLight dark:text-textDark opacity-90 font-normal leading-tight">
      ...
      <li className="flex space-x-3 items-center line-through decoration-textLight dark:decoration-textDark opacity-60">
        ...
        <span className="text-base font-normal leading-tight text-textLight dark:text-textDark">
          {props.text === undefined ? "Unknown feature" : props.text}
        </span>
      </li>
    )
