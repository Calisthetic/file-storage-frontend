  ...
  return (
    ...
    className="w-full min-h-fullWithHeader h-fullWithHeader px-2 md:px-6">
      ...
      {isDragVisible === true ? (
        ...
        onMouseMove={VisualizeUploader} className="absolute transition-dropFiles top-0 left-0 z-50 !h-[100vh] !w-[100dvw] bg-black/70">
          <FileUploader onDragEnter={VisualizeUploader} multiple={true} onTypeError={(err:any) => console.log(err)} 
          classes=" !max-h-[100vh] !h-full !max-w-[100dvw] !w-full justify-center text-center fill-white
