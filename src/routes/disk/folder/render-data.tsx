  ...
  return (
    <main className="py-4">
      {currentRenderType === "list" ? (
        ...
        <div>
          <div className="font-bold bg-backgroundLight dark:bg-backgroundDark text-textLight dark:text-textDark uppercase mb-10
          w-full whitespace-nowrap overflow-y-visible text-base text-left flex flex-row items-center sm:rounded-t-lg">
