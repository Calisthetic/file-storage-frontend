  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        className="mt-10 text-center text-xl sm:text-2xl font-bold leading-9 tracking-tight text-textLight dark:text-textDark">Sign in to your account</motion.h2>
      </div>
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              className="block text-sm font-medium leading-6 text-textLight dark:text-textDark">Password</motion.label>
                <motion.a initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{delay: 0.1, damping: 24, stiffness: 300}}
                 href="#" className="text-sm font-semibold text-buttonLight dark:text-buttonDark 
                hover:text-buttonHoverLight dark:hover:text-buttonHoverDark">Forgot password?</motion.a>
          ...
          <div>
            <motion.button initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{delay: 0.14, damping: 24, stiffness: 300}}
             type="submit" className="flex w-full justify-center rounded-md bg-buttonLight dark:bg-buttonDark 
              ...
              text-textLight shadow-sm dark:text-textDark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</motion.button>
          </div>
        </form>
